    ...
    .values([
      {
        ...
        policyKey: 'workflow.incident.severity.review',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
      {
        ...
        sequenceNumber: 2,
        isRequired: true,
        toolBinding: 'ticket-routing-tool',
        approvalRequired: false,
        policyKey: 'workflow.incident.owner.assignment',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
      {
        ...
        policyKey: 'workflow.incident.escalation.approval',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
      {
        ...
        isRequired: true,
        approvalRequired: false,
        policyKey: 'workflow.change.request.review',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
      {
        ...
        isRequired: true,
        approvalRequired: true,
        policyKey: 'workflow.change.execution.approval',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
      {
        ...
        sequenceNumber: 1,
        isRequired: true,
        assistantBinding: 'operations-runbook-assistant',
        approvalRequired: false,
        policyKey: 'workflow.runbook.ai.preparation',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
      {
        ...
        sequenceNumber: 2,
        isRequired: true,
        toolBinding: 'runbook-execution-tool',
        approvalRequired: false,
        policyKey: 'workflow.runbook.tool.execution',
        createdByActorId: WORKFLOW_SCOPE.createdByActorId,
        updatedByActorId: WORKFLOW_SCOPE.updatedByActorId,
      },
    ])
